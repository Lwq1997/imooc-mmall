...
import com.lwq.mmall.common.TokenCache;
import com.lwq.mmall.dao.UserMapper;
import com.lwq.mmall.pojo.User;
import com.lwq.mmall.service.IUserService;
import com.lwq.mmall.util.MD5Util;
...
public class UserServiceImpl implements IUserService {
    ...
    public ServerResponse<String> selectQuestion(String username) {
        ...
        return ServerResponse.createByErrorMessage("该用户的密码问题为空");
    }
    ...
    public ServerResponse<String> forgetResetPassword(String username, String passwordNew, String forgetToken) {
        ...
        if(StringUtils.equals(forgetToken,token)){
            ...
            if(resultCount>0){
                return ServerResponse.createBySuccessMessage("密码更换成功");
            }
        }else {
            return ServerResponse.createByErrorMessage("token错误，请重新获取重置密码的token");
        }
        return ServerResponse.createByErrorMessage("密码更换失败");
    }
    ...
    public ServerResponse<User> updateInformation(User user) {
        ...
        if(resultCount>0){
            return ServerResponse.createByErrorMessage("电话已经存在，请更换电话后更新");
        }
